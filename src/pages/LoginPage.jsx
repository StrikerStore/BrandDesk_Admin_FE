    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          color: '#fff', fontWeight: 800, fontSize: 20, marginBottom: 16,
        }}>B</div>
        <h1 style={{ fontSize: 20, fontWeight: 700, marginBottom: 6 }}>BrandDesk Admin</h1>
        ...
        <p style={{ fontSize: 11, color: 'var(--text-muted)', marginTop: 20 }}>
          Only platform administrators can access this panel.
        </p>
      </div>
    </div>
  );
